      ...
      <StyledAppBar position="sticky" sx={{ boxShadow: headerShadow ? 3 : 0 }}>
        <Toolbar sx={{ py: 1 }}>
          ...
          <Box sx={{ flex: 1, display: "flex", justifyContent: "center", gap: 4 }}>
            <Link href="/" underline="none" sx={{ fontWeight: 600, color: navTextColor, cursor: "pointer" }}>
              Home
            </Link>
            <Link href="/services" underline="none" sx={{ fontWeight: 600, color: navTextColor, cursor: "pointer" }}>
              Services
            </Link>
            <Link href="/about" underline="none" sx={{ fontWeight: 600, color: navTextColor, cursor: "pointer" }}>
              About
            </Link>
          </Box>
